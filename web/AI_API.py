...
3. 分析温度较低时开风扇是否浪费
n4. 根据用户作息（工作日：8-11，13-17 上课；23-8 睡觉）判断是否有人在但电器保持开启导致浪费
5. 给出最有效的节能提醒或自动化建议
 
【数据格式说明】
数据采用横向键值对格式：{{"light":500,"humi":60,"temp":25,"pir":1,"fan_power":5.2,"fan_level":2,"light_power":3.7,"light_level":1,"time":"10:30"}}
